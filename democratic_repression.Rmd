...
intrastate_two_start <- reshape::untable(intrastate, num = intrastate$two_start)
...
intrastate_expand_first <- reshape::untable(intrastate_pre_expand, num = intrastate_pre_expand$duration1)

intrastate_expand <- reshape::untable(intrastate_expand_first, num = intrastate_expand_first$duration2)
```
