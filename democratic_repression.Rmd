...
analysis <- left_join(system_month, intrastate_expand) %>%
...
analysis <- left_join(analysis, interstate_final) %>% 
...
analysis$year <- as.numeric(format(analysis$year_month, "%Y"))

analysis <- left_join(analysis, vdem_controls)
```
